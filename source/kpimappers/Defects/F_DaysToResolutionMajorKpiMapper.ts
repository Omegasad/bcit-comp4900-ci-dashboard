...
/**
 * F_DaysToResolutionMajorKpiMapper.
 * 
 * Days with no data will be ignored (not plotted).
 */
export class F_DaysToResolutionMajorKpiMapper extends KpiMapper
{
    public readonly Title: string = "Days To Resolve Major Bugs";

    private _yAxisTitle: string = "Days (lower is better)";

    // Target and stretch goals
    private _targetGoal: number = config.kpi.goals.bugs_resolution_time_major.target;
    private _stretchGoal: number = config.kpi.goals.bugs_resolution_time_major.stretch;
